...
public class CinemaInitServiceImpl implements ICinemaInitService {
	...
	public void initCinemas() {
		villeRepository.findAll().forEach(v -> {
			Stream.of("Imax", "Megarama", "Dawliz", "UTC").forEach(nameCinema -> {
	...
	public void initCategories() {
		Stream.of("Adventure", "Actions", "Fiction", "Drama","thriller").forEach(cat -> {
	...
	public void initFilms() {
		...
		Stream.of("Avengers End Game", "Joker", "Fight Club", "Parasite", "Le Parrain",
				"John Wick Chapter3 Parabellum").forEach(titreFilm -> {
					Film film = new Film();
